...
public class SnapToGridPolicy implements SnapPolicy {
    public static final String ENABLED_KEY = SnapToGridPolicy.class.getName() +
        " - ENABLED";
    public static final String GRID_SIZE_KEY = SnapToGridPolicy.class.getName() +
        " - GRID_SIZE";
    ...
    public Coordinate snap(LayerViewPanel panel, Coordinate originalCoordinate) {
        ...
        return (gridCoordinate.distance(originalCoordinate) <= (SnapManager.getToleranceInPixels(blackboard) / panel.getViewport()
                                                                                                                    .getScale()))
        ? gridCoordinate : originalCoordinate;
    }
}
