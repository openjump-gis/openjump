...
public class MaximalBreaksColorThemingState implements ColorThemingStylePanel.State {
    private ColorThemingStylePanel stylePanel;
    private static final String RANGE_COUNT_KEY =
        MaximalBreaksColorThemingState.class.getName() + " - MAXBREAKS COUNT";
    ...
    public Collection filterAttributeValues(SortedSet attributeValues) {
        ...
        double[] breaks = Classifier1D.classifyMaxBreaks(data, classCount);
    ...
    public MaximalBreaksColorThemingState(final ColorThemingStylePanel stylePanel) {
