...
alignLeftMenu = swing.JMenuItem("Left", actionPerformed=AlignSelected.alignLeft)
alignTopMenu = swing.JMenuItem("Top", actionPerformed=AlignSelected.alignTop)
alignRightMenu = swing.JMenuItem("Right", actionPerformed=AlignSelected.alignRight)
alignBottomMenu = swing.JMenuItem("Bottom", actionPerformed=AlignSelected.alignBottom)
alignVerticalMenu = swing.JMenuItem("Center Vertical", actionPerformed=AlignSelected.alignVertical)
alignHorizontalMenu = swing.JMenuItem("Center Horizontal", actionPerformed=AlignSelected.alignHorizontal)
...
distributeMenu = swing.JMenu("Distribute Selected")
distributeVerticalMenu = swing.JMenuItem("Vertical", actionPerformed=DistributeSelected.distributeVertical)
distributeHorizontalMenu = swing.JMenuItem("Horizontal", actionPerformed=DistributeSelected.distributeHorizontal)
