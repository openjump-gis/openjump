...
!define PRODUCT_VERSION "1.4.0.3"
...
;  SetOutPath "$INSTDIR\bin"
  ...
  File "openjump-1.4.0.3forwin\bin\oj_linux.sh"
  File "openjump-1.4.0.3forwin\bin\oj_macosx.command"
  File "openjump-1.4.0.3forwin\bin\oj_windows.bat"
  SetOutPath "$INSTDIR\bin\OpenJUMP.app\Contents"
  File "openjump-1.4.0.3forwin\bin\OpenJUMP.app\Contents\Info.plist"
  SetOutPath "$INSTDIR\bin\OpenJUMP.app\Contents\MacOS"
  File "openjump-1.4.0.3forwin\bin\OpenJUMP.app\Contents\MacOS\oj.sh"
  SetOutPath "$INSTDIR\bin\OpenJUMP.app\Contents\Resources"
  File "openjump-1.4.0.3forwin\bin\OpenJUMP.app\Contents\Resources\oj.icns"
  SetOutPath "$INSTDIR\bin"
  File "openjump-1.4.0.3forwin\bin\OpenJUMP.exe"
  ...
  File "openjump-1.4.0.3forwin\bin\OpenJUMP.ini"
  File "openjump-1.4.0.3forwin\bin\openjump_icon3.ico"
  File "openjump-1.4.0.3forwin\bin\workbench-properties.xml"
  SetOutPath "$INSTDIR"
  File "openjump-1.4.0.3forwin\Changes.txt"
  SetOutPath "$INSTDIR\lib"
  File "openjump-1.4.0.3forwin\lib\.project"
  File "openjump-1.4.0.3forwin\lib\batik-all.jar"
  File "openjump-1.4.0.3forwin\lib\bsh-2.0b4.jar"
  File "openjump-1.4.0.3forwin\lib\Buoy.jar"
  File "openjump-1.4.0.3forwin\lib\ermapper.jar"
  SetOutPath "$INSTDIR\lib\ext\BeanTools"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\0-Help.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\1-HelloWorld.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\2-NewLayer.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\3-Populate.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\4-AddAttribute.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\5-ChangeAttributeValue.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\6-PushPinPoints.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\7-AddXYAsAttributes.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\8-GetInvalidShapefileRings.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\RefreshScriptsMenu.bsh"
  File "openjump-1.4.0.3forwin\lib\ext\BeanTools\SaveViewAsBeanTool.bsh"
  SetOutPath "$INSTDIR\lib\ext\jython"
  File "openjump-1.4.0.3forwin\lib\ext\jython\AlignSelected.py"
  File "openjump-1.4.0.3forwin\lib\ext\jython\ArcTool.py"
  File "openjump-1.4.0.3forwin\lib\ext\jython\CircleTool.py"
  File "openjump-1.4.0.3forwin\lib\ext\jython\DistributeSelected.py"
  SetOutPath "$INSTDIR\lib\ext\jython\images"
  File "openjump-1.4.0.3forwin\lib\ext\jython\images\DrawArc.gif"
  File "openjump-1.4.0.3forwin\lib\ext\jython\images\DrawCircle.gif"
  File "openjump-1.4.0.3forwin\lib\ext\jython\images\DrawCorner.gif"
  File "openjump-1.4.0.3forwin\lib\ext\jython\images\DrawOval.gif"
  File "openjump-1.4.0.3forwin\lib\ext\jython\images\DrawPoint.gif"
  File "openjump-1.4.0.3forwin\lib\ext\jython\images\DrawRoad.gif"
  File "openjump-1.4.0.3forwin\lib\ext\jython\images\DrawRotRect.gif"
  SetOutPath "$INSTDIR\lib\ext\jython"
  File "openjump-1.4.0.3forwin\lib\ext\jython\OvalTool.py"
  File "openjump-1.4.0.3forwin\lib\ext\jython\RightAngleTool.py"
  File "openjump-1.4.0.3forwin\lib\ext\jython\RoadTool.py"
  File "openjump-1.4.0.3forwin\lib\ext\jython\RotatedRectangleTool.py"
  File "openjump-1.4.0.3forwin\lib\ext\jython\SetASHSLabel.py"
  File "openjump-1.4.0.3forwin\lib\ext\jython\startup.py"
  File "openjump-1.4.0.3forwin\lib\ext\jython\UnionSelected.py"
  SetOutPath "$INSTDIR\lib\ext"
  File "openjump-1.4.0.3forwin\lib\ext\NCScnet.dll"
  File "openjump-1.4.0.3forwin\lib\ext\NCSEcw.dll"
  File "openjump-1.4.0.3forwin\lib\ext\NCSUtil.dll"
  File "openjump-1.4.0.3forwin\lib\ext\readme.txt"
  SetOutPath "$INSTDIR\lib"
  File "openjump-1.4.0.3forwin\lib\jai_codec.jar"
  File "openjump-1.4.0.3forwin\lib\jai_core.jar"
  File "openjump-1.4.0.3forwin\lib\Jama-1.0.1.jar"
  File "openjump-1.4.0.3forwin\lib\jdom.jar"
  File "openjump-1.4.0.3forwin\lib\jmatharray-20070905.jar"
  File "openjump-1.4.0.3forwin\lib\jmathplot-20070905.jar"
  File "openjump-1.4.0.3forwin\lib\jts-1.11.jar"
  File "openjump-1.4.0.3forwin\lib\jython.jar"
  File "openjump-1.4.0.3forwin\lib\log4j-1.2.16.jar"
  File "openjump-1.4.0.3forwin\lib\openjump-api-1.4.0.3.jar"
  File "openjump-1.4.0.3forwin\lib\openjump-workbench-1.4.0.3.jar"
  File "openjump-1.4.0.3forwin\lib\postgis_1_0_0.jar"
  File "openjump-1.4.0.3forwin\lib\postgresql-9.0-801.jdbc3.jar"
  File "openjump-1.4.0.3forwin\lib\xercesImpl.jar"
  File "openjump-1.4.0.3forwin\lib\xml-apis-ext.jar"
  File "openjump-1.4.0.3forwin\lib\xml-apis.jar"
  SetOutPath "$INSTDIR\licenses"
  File "openjump-1.4.0.3forwin\licenses\apache_license.txt"
  File "openjump-1.4.0.3forwin\licenses\gpl2_license.txt"
  File "openjump-1.4.0.3forwin\licenses\jmath_license.txt"
...
;  Delete "$INSTDIR\workbench-state.xml"
  ...
  Delete "$INSTDIR\lib\openjump-workbench-1.4.0.3.jar"
  Delete "$INSTDIR\lib\openjump-api-1.4.0.3.jar"
