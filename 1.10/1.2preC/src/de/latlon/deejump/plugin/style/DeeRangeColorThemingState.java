...
public class DeeRangeColorThemingState implements ColorThemingStylePanel.State {
    private DeeColorThemingStylePanel stylePanel;
    ...
    public DeeRangeColorThemingState(final DeeColorThemingStylePanel stylePanel) {
