 ...
 */
public class MultiInputDialogWithoutCancel extends JDialog {
     ...
     */
    public MultiInputDialogWithoutCancel(final Frame frame, String title, boolean modal) {
    ...
    public void setVisible(boolean visible) {
        ...
        pack();
        pack();
        GUIUtil.centreOnWindow(MultiInputDialogWithoutCancel.this);
