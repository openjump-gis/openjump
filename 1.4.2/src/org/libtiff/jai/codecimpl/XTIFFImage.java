 ...
 * 
 * The contents of this file are subject to the JAVA ADVANCED IMAGING SAMPLE
 * INPUT-OUTPUT CODECS AND WIDGET HANDLING SOURCE CODE License Version 1.0 (the
 ...
 * 
 * The Original Code is JAVA ADVANCED IMAGING SAMPLE INPUT-OUTPUT CODECS AND
 * WIDGET HANDLING SOURCE CODE. The Initial Developer of the Original Code is:
 * Sun Microsystems, Inc.. Portions created by: Niles Ritter are Copyright (C):
 * Niles Ritter, GeoTIFF.org, 1999,2000. All Rights Reserved. Contributor(s):
 * Niles Ritter
 */
...
public class XTIFFImage extends SimpleRenderedImage
{
   ...
   */
  public XTIFFImage(SeekableStream stream, TIFFDecodeParam param, int directory)
      throws IOException
  {
  ...
  protected void setupImageParameters()
  {
    ...
    photometric_interp = (int) dir
        .getFieldAsLong(XTIFF.TIFFTAG_PHOTOMETRIC_INTERPRETATION);
    ...
    } else
    {
      ...
      XTIFFField tileByteCountsField = dir
          .getField(XTIFF.TIFFTAG_STRIP_BYTE_COUNTS);
          ...
          if (bitsPerSample[0] == 4)
          {
            ...
            if (bitsPerSample[0] == 8)
            {
              sampleModel = RasterFactory.createPixelInterleavedSampleModel(
                  DataBuffer.TYPE_BYTE, tileWidth, tileHeight, bands);
              ...
              {
                throw new IllegalArgumentException(JaiI18N
                    .getString("XTIFFImageDecoder14"));
              }
        }
...
//        bands = 1;
        ...
        } else
        {
          ...
          if (bitsPerSample[0] == 4)
          {
            sampleModel = new MultiPixelPackedSampleModel(DataBuffer.TYPE_BYTE,
                tileWidth, tileHeight, 4);
            colorModel = ImageCodec
                .createGrayIndexColorModel(sampleModel, true);
          } else
            if (bitsPerSample[0] == 8)
            {
              sampleModel = RasterFactory.createPixelInterleavedSampleModel(
          ...
          if (samplesPerPixel == 3)
          {
            ...
            if (samplesPerPixel == 4)
            {
              ...
              if (extraSamples == 0)
              {
                ...
                // what we want.
                colorModel = createAlphaComponentColorModel(dataType, true,
            ...
            } else
            {
              ...
              if (bitsPerSample[0] == 8)
              {
                ...
                sampleModel = new PixelInterleavedSampleModel(
                    DataBuffer.TYPE_BYTE, tileWidth, tileHeight, bands, bands
                ...
                if (bitsPerSample[0] == 16)
                {
                  ...
                  sampleModel = new PixelInterleavedSampleModel(dataType,
                      tileWidth, tileHeight, bands, bands * tileWidth,
                      bandOffsets);
                  colorModel = null;
                }
            }
...
//          bands = 1;
          ...
          if (bitsPerSample[0] == 4)
          {
            ...
            sampleModel = new MultiPixelPackedSampleModel(DataBuffer.TYPE_BYTE,
                tileWidth, tileHeight, bitsPerSample[0]);
          } else
            if (bitsPerSample[0] == 8)
            {
              sampleModel = RasterFactory.createPixelInterleavedSampleModel(
              ...
              if (bitsPerSample[0] == 16)
              {
                ...
                sampleModel = RasterFactory.createPixelInterleavedSampleModel(
                    DataBuffer.TYPE_USHORT, tileWidth, tileHeight, bands);
              } else
              {
                throw new RuntimeException(JaiI18N
                    .getString("XTIFFImageDecoder13"));
              }
          ...
          colorModel = new IndexColorModel(bitsPerSample[0], bandLength, r, g,
              b);
        }
  ...
  private ComponentColorModel createAlphaComponentColorModel(int dataType,
      boolean hasAlpha, boolean isAlphaPremultiplied, int transparency)
  {
    ...
    ccm = new ComponentColorModel(ColorSpace.getInstance(ColorSpace.CS_sRGB),
        RGBBits[dataType], hasAlpha, isAlphaPremultiplied, transparency,
        dataType);
    return ccm;
  }
}
