...
class DropDownButton extends JButton {
    ...
    public DropDownButton( Icon icon, JPopupMenu popup ) {
        ...
        setIcon( icon );
//<modified for OJ>        setDisabledIcon(ImageUtilities.createDisabledIcon(icon));
...
//<modified for OJ>            arrow = new ImageIcon(ImageUtilities.icon2Image(new IconWithArrow( orig, false )));
