...
public class GradientLabelLegendComponent extends JComponent{
    ...
    private void jInit(){
        ...
        ColorMapEntry[] paletteColorMapEntry = new ColorMapEntry[colorMapEntries_tm.size() - 1]; //without noDataValue
        int count = 0;
        ...
        JLabel jLabel_NoDataTitle  = new JLabel(bundle.getString("LegendDialog.NoDataValue.text"));
        ...
        jLabel_NoDataColor.setBackground(noDataColor);
         jLabel_NoDataColor.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
