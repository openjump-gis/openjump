...
{
	  private static String UPDATE_SRC = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Update-the-polygon-with-result");
	  private static String ADD_TO_SRC = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Add-result-to-the-polygon-layer");
	  private static String CREATE_LYR = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Create-new-layer-for-result");
	  private static String sCutPolygon = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Cut-Polygon");
	  private static String sError = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Errors-found-while-executing-Cut-Polygon");
	  private static String sExecuting = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Executing-Difference-function");
	  private static String sMustSelect = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Must-select-one-polygon-and-one-linestring");
	  private static String sDescription = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Uses-the-selected-linestring-to-cut-the-selected-polygon-into-separate-sections");
	  ...
	  public void initialize(PlugInContext context) throws Exception 
	  {
		  ...
		  UPDATE_SRC = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Update-the-polygon-with-result");
		  ADD_TO_SRC = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Add-result-to-the-polygon-layer");
		  CREATE_LYR = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Create-new-layer-for-result");
		  sCutPolygon = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Cut-Polygon");
		  sError = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Errors-found-while-executing-Cut-Polygon");
		  sExecuting = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Executing-Difference-function");
		  sMustSelect = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Must-select-one-polygon-and-one-linestring");
		  sDescription = I18N.getInstance().get("org.openjump.core.ui.plugin.tools.SplitPolygonPlugIn.Uses-the-selected-linestring-to-cut-the-selected-polygon-into-separate-sections");
		  ...
		  differenceFunction = GeometryFunction.getFunction(I18N.getInstance().get("ui.plugin.analysis.GeometryFunction.difference-a-b"));
		  intersectionFunction = GeometryFunction.getFunction(I18N.getInstance().get("ui.plugin.analysis.GeometryFunction.intersection"));
