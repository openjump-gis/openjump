...
public class ReducePointsISAPlugIn extends AbstractPlugIn {
  ...
  private final static String sSimplifyISA = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.ReducePointsISAPlugIn.Simplify-ISA-algorithm");
  private final static String sPointsReducedFrom = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.ReducePointsISAPlugIn.Points-reduced-from");
  private final static String sTo = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.ReducePointsISAPlugIn.to");
  private final static String sReducePointsInSelectedFeatures = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.ReducePointsISAPlugIn.Reduce-points-in-selected-features");
  private final static String sTheReducePointsTolerance = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.ReducePointsISAPlugIn.The-reduce-points-tolerance");

  private WorkbenchContext workbenchContext;
  private final static String TOLERANCE = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.ReducePointsISAPlugIn.Tolerance");;
  ...
  public void initialize(PlugInContext context) throws Exception {
    ...
    /*
     * gContext = context; FeatureInstaller featureInstaller =
     * context.getFeatureInstaller(); JPopupMenu popupMenu =
     * LayerViewPanel.popupMenu(); featureInstaller.addPopupMenuItem(popupMenu,
     * this, sSimplifyISA, false, null, this.createEnableCheck(workbenchContext));
     */

    context.getFeatureInstaller().addMainMenuItem(this,
        new String[] { MenuNames.TOOLS, MenuNames.TOOLS_GENERALIZATION }, sSimplifyISA, false, null,
  ...
  private EditTransaction createTransaction(Layer layer, final double tolerance) {
    ...
    }, workbenchContext.getLayerViewPanel(), workbenchContext.getLayerViewPanel().getContext(), getName(), layer, false,
        false);
    return transaction;
  }
  ...
  private Geometry reduceGeo(Geometry geometry, double tolerance) {
    ...
    } else if (geometry instanceof Polygon) // poly with 0 or more holes
    {
      ...
      GeometryFactory geoFac = geometry.getFactory();
      PackedCoordinateSequenceFactory dcsf = new PackedCoordinateSequenceFactory();
