...
public class Add3DGeometryAttributesPlugIn extends AbstractThreadedUiPlugIn {
  ...
  private static String LAYER = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.layer");

  private static String GEOM_ATTRIBUTES = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.3d-geometry-attributes");

  private static String COMPUTE_ATTRIBUTES = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.compute-attributes");

  private static String START_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.start-z");
  private static String ADD_START_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-start-z");

  private static String END_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.end-z");
  private static String ADD_END_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-end-z");

  private static String MIN_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.min-z");
  private static String ADD_MIN_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-min-z");

  private static String MAX_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.max-z");
  private static String ADD_MAX_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-max-z");

  private static String WEIGHTED_MEAN_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.weighted-mean-z");
  private static String ADD_WEIGHTED_MEAN_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-weighted-mean-z");

  private static String LENGTH_3D = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.length-3d");
  private static String ADD_LENGTH_3D = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-length-3d");

  private static String MAX_DOWN_SLOPE = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.max-downslope");
  private static String ADD_MAX_DOWNSLOPE = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-max-downslope");

  private static String MAX_UPSLOPE = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.max-upslope");
  private static String ADD_MAX_UPSLOPE = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-max-upslope");

  private static String MAX_SLOPE = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.max-slope");
  private static String ADD_MAX_SLOPE = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-max-slope");

  private static String NB_NAN_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.nb-nan-z");
  private static String ADD_NB_NAN_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-nb-nan-z");

  private static String NB_NEGATIVE_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.nb-negative-z");
  private static String ADD_NB_NEGATIVE_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-nb-negative-z");

  private static String NB_0_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.nb-0-z");
  private static String ADD_NB_0_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-nb-0-z");

  private static String NB_POSITIVE_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.nb-positive-z");
  private static String ADD_NB_POSITIVE_Z = I18N.getInstance()
      .get("org.openjump.core.ui.plugin.tools.Add3DGeometryAttributesPlugIn.add-nb-positive-z");
  //
  // // MORPHOLOGY
  // public static String ADD_ORIENTATION =
  // I18N.getInstance().get("org.openjump.core.ui.plugin.tools.AddGeometryAttributesPlugIn.add-orientation");
  // // http://iahs.info/hsj/470/hysj_47_06_0921.pdf
  // // http://www.ipublishing.co.in/jggsvol1no12010/voltwo/EIJGGS3022.pdf
  // public static String ADD_GRAVELIUS =
  // I18N.getInstance().get("org.openjump.core.ui.plugin.tools.AddGeometryAttributesPlugIn.add-miller");
  // public static String ADD_MILLER =
  // I18N.getInstance().get("org.openjump.core.ui.plugin.tools.AddGeometryAttributesPlugIn.add-miller");

  // public static String ADD_SINUOSITY =
  // I18N.getInstance().get("org.openjump.core.ui.plugin.tools.AddGeometryAttributesPlugIn.add-miller");
  ...
  private void setGeometryAttributes(Feature f) {
    ...
    if (addStartZ)
      f.setAttribute(START_Z, cc[0].z);
    if (addEndZ)
      f.setAttribute(END_Z, cc[cc.length - 1].z);
    ...
    if (addMinZ)
      f.setAttribute(MIN_Z, minZ);
    if (addMaxZ)
      f.setAttribute(MAX_Z, maxZ);
    if (addNbNaNZ)
      f.setAttribute(NB_NAN_Z, nbNaNZ);
    if (addNbNegativeZ)
      f.setAttribute(NB_NEGATIVE_Z, nbNegativeZ);
    if (addNb0Z)
      f.setAttribute(NB_0_Z, nb0Z);
    if (addNbPositiveZ)
      f.setAttribute(NB_POSITIVE_Z, nbPositiveZ);
      ...
      for (int i = 0; i < g.getNumGeometries(); i++) {
        ...
        for (ZBoundedSubLineString line : list) {
          ...
          if (Double.isNaN(maxDownslope))
            ...
            if (!Double.isNaN(slope) && slope < maxDownslope)
              maxDownslope = slope;
          }
          if (Double.isNaN(maxUpslope))
            maxUpslope = slope;
          else {
            if (!Double.isNaN(slope) && slope > maxUpslope)
              maxUpslope = slope;
          }
          if (Double.isNaN(maxSlope))
            maxSlope = Math.abs(slope);
          else {
            if (!Double.isNaN(slope) && Math.abs(slope) > maxSlope)
              maxSlope = Math.abs(slope);
          }
        }
      }
    ...
    if (addLength3d)
      f.setAttribute(LENGTH_3D, length3d);
    if (addWeightedMeanZ)
      f.setAttribute(WEIGHTED_MEAN_Z, weightedMeanZ);
    if (addMaxDownslope)
      f.setAttribute(MAX_DOWN_SLOPE, 100 * maxDownslope);
    if (addMaxUpslope)
      f.setAttribute(MAX_UPSLOPE, 100 * maxUpslope);
    if (addMaxSlope)
      f.setAttribute(MAX_SLOPE, 100 * maxSlope);
  }
  ...
  private static class ZBoundedSubLineString {
    ...
    /**
     * Return the length3d of this substring if both start and end points have a z,
     * length2d elseif.
     */
    ...
    private double getWeightedZ() {
      if (Double.isNaN(dz)) {
        if (!Double.isNaN(startZ))
          return startZ * length2d;
        if (!Double.isNaN(endZ))
          return endZ * length2d;
        return Double.NaN;
      } else
        return (startZ + (dz / 2.0)) * length2d;
    }

    /**
     * Return the signed slope of the sublinestring (dz/length2d) or NaN if it
     * contains only one or z value.
     */
