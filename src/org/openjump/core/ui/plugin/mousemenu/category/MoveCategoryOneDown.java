...
public class MoveCategoryOneDown extends AbstractPlugIn { 
    ...
    public Icon getIcon() {
        return IconLoader.icon("bullet_arrow_down.png");
    }
    
    public String getName(){
    	return 	I18N.getInstance().get("org.openjump.core.ui.plugin.mousemenu.category.MoveCategoryOneDown.Move-Category-One-Down");
    }
