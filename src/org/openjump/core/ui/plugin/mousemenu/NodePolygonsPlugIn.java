 ...
 */
public class NodePolygonsPlugIn extends AbstractThreadedUiPlugIn {
    
    public static final ImageIcon ICON = IconLoader.icon("node_polygons.png");
    
    NoderPlugIn noder = new NoderPlugIn();
    
    public NodePolygonsPlugIn() { }
    ...
    public void run(TaskMonitor monitor, PlugInContext context) throws Exception {
        ...
        noder.setLineProcessor(NoderPlugIn.Processor.DO_NOT_PROCESS);
