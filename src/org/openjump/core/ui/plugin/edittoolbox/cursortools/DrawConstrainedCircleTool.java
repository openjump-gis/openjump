...
public class DrawConstrainedCircleTool extends ConstrainedMultiClickTool {
    ...
    public Icon getIcon() {
        return new ImageIcon(getClass()
                .getResource("DrawCircleConstrained.gif"));
    }
    ...
    private Polygon getCircle3points(Coordinate a, Coordinate b, Coordinate c) {
        ...
        if (G != 0.0) {
            ...
            return circle.getPoly();
        } else // points are colinear; use second for center; third for the
               // radius
        {
     ...
     * 
     * @see
     * com.vividsolutions.jump.workbench.ui.cursortool.AbstractCursorTool#getShape
     * ()
     */
    @Override
    ...
    private void display(List<Coordinate> coordinates, LayerViewPanel panel)
        ...
        if (getCoordinates().size() > 0) {
            ...
            if (getCoordinates().size() == 1) {
                ...
                Coordinate c = tentativeCoordinate;
                polygon = getCircle3points(a, b, c);
            }
            ...
            getPanel().getContext().setStatusMessage(
                    ...
                    "radius" + ": " + df3.format(radius) + ";  " + lengthST
                            + ": " + df3.format(circum) + ";  " + sArea + ": "
                            + df3.format(polygon.getArea()));
