...
//            QuasimodeTool quasimodeTool = new QuasimodeTool(new ConstrainedMoveVertexTool(EnableCheckFactory.getInstance(toolbox.getContext())));
...
//            quasimodeTool.add(new QuasimodeTool.ModifierKeySpec(true, true, false), null);
            toolbox.add(new ConstrainedMoveVertexTool(toolbox.getContext()), null);
