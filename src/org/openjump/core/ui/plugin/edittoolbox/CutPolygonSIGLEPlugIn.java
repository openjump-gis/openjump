 ...
 * of another polygon. To use it, select a Polygon A, click the
 * CutPolygonSIGLEPlugIn in the editing toolbox, and draw a polygon B. Result
 * will be the polygon A - B.
 * 
 * @author ERWAN BOCHER Laboratoire RESO UMR CNRS 6590, Olivier Bonnefont, Ugo
 *         Tadei
...
public class CutPolygonSIGLEPlugIn extends AbstractPlugIn {
   ...
   * (non-Javadoc)
   * 
   * @see com.vividsolutions.jump.workbench.plugin.AbstractPlugIn#initialize(com.
   * vividsolutions.jump.workbench.plugin.PlugInContext)
   */
