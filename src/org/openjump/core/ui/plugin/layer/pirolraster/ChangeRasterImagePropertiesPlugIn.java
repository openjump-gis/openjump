...
public class ChangeRasterImagePropertiesPlugIn extends AbstractPlugIn {
	 private final static String LAST_TAB_KEY = ChangeRasterImagePropertiesPlugIn.class.getName() +
		        " - LAST TAB";
		...
		/* Deactivated     
          ...
          */
			public boolean execute(PlugInContext context) throws Exception{
					...
					final MultiInputDialog dialog = new MultiInputDialog(context.getWorkbenchFrame(),
		                I18N.get("org.openjump.core.ui.plugin.layer.pirolraster.ChangeRasterImagePropertiesPlugIn.Change-Raster-Image-Properties"), true);
					...
					final RasterTransparencyPanel rasstyle = new RasterTransparencyPanel(rLayer);
					final RasterColorEditorPanel rascolorpanel = new RasterColorEditorPanel(context, rLayer);
