...
public class RasterImageLayerControllPanel extends JPanel implements ValueChecker, ActionListener {
    ...
    public void setupGui(){
        ...
        transparencyOnOffPanel.add(new JLabel(I18N.get("Do-you-want-a-color-to-be-transparent"))); //$NON-NLS-1$
        ...
        this.colorChooser.setToolTipText(I18N.get("Choose-transparent-color")); //$NON-NLS-1$
        ...
        transparencySliderPanel.add(new JLabel(I18N.get("set-overall-transparency"))); //$NON-NLS-1$
        ...
        speedSliderPanel.add(new JLabel(I18N.get("processing-speed"))); //$NON-NLS-1$
