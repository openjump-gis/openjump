...
public class ChangeRasterImageStyleDialog extends JDialog {
	...
	private void initialize() {
		...
		this.jContentPane.add(DialogTools.getPanelWithLabels(I18N.get("org.openjump.core.ui.plugin.layer.pirolraster.ChangeRasterImageStyleDialog.Change-RasterImage-Style-Dialog-intro-text"), 65), BorderLayout.NORTH);
