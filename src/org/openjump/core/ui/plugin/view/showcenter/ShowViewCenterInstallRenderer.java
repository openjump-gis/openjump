 ...
 * 
 */
public class ShowViewCenterInstallRenderer extends InstallRendererPlugIn {
    public ShowViewCenterInstallRenderer() {
        super(ShowViewCenterRenderer.CONTENT_ID, true);
    }
    ...
    protected Renderer.Factory createFactory(final TaskFrame frame) {
        return new Renderer.Factory() {
            ...
            public Renderer create() {
                return new ShowViewCenterRenderer(frame.getLayerViewPanel());
            }
        };
    }
}