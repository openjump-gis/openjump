...
public class InputChangedFirer {
    ...
    //Common code shared by several classes. [Jon Aquino]
    public InputChangedFirer() {
    }
    ...
    public void fire() {
        for (Iterator i = inputChangedListeners.iterator(); i.hasNext();) {
            InputChangedListener listener = (InputChangedListener) i.next();
