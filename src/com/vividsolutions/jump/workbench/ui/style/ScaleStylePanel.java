...
public class ScaleStylePanel extends JPanel implements StylePanel {
    ...
    private void initialize() {
        ...
        //smallestScaleLabel.setToolTipText(I18N.getInstance().get("ui.style.ScaleStylePanel.larger-units-pixel")); //[sstein] 8.Mar.2009 
        ...
        //unitsPerPixelLabel.setText(I18N.getInstance().get("ui.style.ScaleStylePanel.units-pixel")); //[sstein] 8.Mar.2009 
        ...
        //largestScaleLabel.setToolTipText(I18N.getInstance().get("ui.style.ScaleStylePanel.smaller-units-pixel")); //[sstein] 8.Mar.2009 
