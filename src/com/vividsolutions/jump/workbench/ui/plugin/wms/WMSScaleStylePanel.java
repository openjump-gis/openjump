...
public class WMSScaleStylePanel extends JPanel implements StylePanel {
 ...
 private static final ImageIcon MAX_SCALE_ICON = GUIUtil.toSmallIcon(IconLoader.icon("Atom.gif"));
  private static final ImageIcon MIN_SCALE_ICON = GUIUtil.toSmallIcon(IconLoader
          .icon("globe3_32.png"));
