...
public class OverlayPlugIn extends AbstractPlugIn implements ThreadedPlugIn {
    ...
    public void initialize(PlugInContext context) throws Exception {
      ...
      featureInstaller.addMainMenuItem(this, new String[] { MenuNames.TOOLS, MenuNames.TOOLS_ANALYSIS },
          new JMenuItem(this.getName() + "..."), createEnableCheck(context.getWorkbenchContext()));
    }
