...
public class SelectFeaturesToolEditToolbox extends SelectTool {
    public SelectFeaturesToolEditToolbox() {
        super(FeatureSelectionRenderer.CONTENT_ID);
    }

    public Icon getIcon() {
        return IconLoader.icon("Select.gif"); //uses the original icon with 20x20px 
