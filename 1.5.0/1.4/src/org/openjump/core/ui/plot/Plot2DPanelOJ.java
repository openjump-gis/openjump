...
public class Plot2DPanelOJ extends PlotPanel {
    ...
    public int addBarPlotOJ(String name, double[] Y, int[] fID, PlugInContext context, Layer layer) {
        return ((Plot2DCanvasOJ) plotCanvas).addBarPlotOJ(name, getNewColor(), Y, fID, context, layer);
    }
    ...
    public int addStaircasePlot(String name, Color color, double[] X,double[] Y) {
        return ((Plot2DCanvasOJ) plotCanvas).addStaircasePlot(name, color, X,Y);
    }
    ...
    public int addHistogramPlot(String name, Color color, double[][] XY, double[] dX) {
        return ((Plot2DCanvasOJ) plotCanvas).addHistogramPlot(name, color, XY, dX);
    }
    ...
    public int addHistogramPlot(String name, Color color, double[][] XYdX) {
        return ((Plot2DCanvasOJ) plotCanvas).addHistogramPlot(name, color, XYdX);
    }
    ...
    public int addHistogramPlot(String name, Color color, double[] sample, int n) {
        return ((Plot2DCanvasOJ) plotCanvas).addHistogramPlot(name, color, sample, n);
    }
    ...
    public int addHistogramPlot(String name, Color color, double[] sample, double... bounds) {
        return ((Plot2DCanvasOJ) plotCanvas).addHistogramPlot(name, color, sample, bounds);
    }
    ...
    public int addHistogramPlot(String name, Color color, double[] X, double min, double max, int n) {
        return ((Plot2DCanvasOJ) plotCanvas).addHistogramPlot(name, color, X, min, max, n);
    }
    ...
    public int addCloudPlot(String name, Color color, double[][] sampleXY, int nX, int nY) {
        return ((Plot2DCanvasOJ) plotCanvas).addCloudPlot(name, color, sampleXY, nX,nY);
    }
